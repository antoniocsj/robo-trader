...
def teste_1():
    ...
    dataset_train = prepare_train_data_multi(hist, symbol_out, 0, candlesticks_quantity, tipo_vela)
    dataset_test = prepare_train_data_multi(hist, symbol_out, candlesticks_quantity, 10, tipo_vela)
    # choose a number of time steps
    n_steps = num_velas_anteriores
