...
class HistMulti:
    def __init__(self, source: Any, timeframe: str, symbols_allowed=None, symbolout=None):
        """
        Carrega os dados históricos de um diretório ou de um dicionário de planilhas.
        :param source: diretório onde se encontra os arquivos csv ou um dicionário de planilhas.
        :param timeframe: timeframe dos arquivos csv.
        :param symbols_allowed: lista dos símbolos que devem ser carregados. Se None, carrega todos.
        :param symbolout: se for especificado, este símbolo ficará em primeiro lugar na lista dos símbolos.
        """
        self.symbols = []
